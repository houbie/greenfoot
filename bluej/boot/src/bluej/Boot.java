...
public class Boot
{
    ...
    private static String[] bluejJars = { "bluejcore.jar", "bluejeditor.jar", "bluejext.jar",
                                          ...
                                          "svnkit-javahl.jar", "svnkit.jar", "trilead.jar", "groovy-2.3.7.jar"};
    ...
    private static final String[] bluejUserJars = { "bluejcore.jar", "junit-4.8.2.jar", "groovy-2.3.7.jar" };
    ...
    private static final String[] greenfootUserJars = {"extensions" + File.separatorChar + "greenfoot.jar", 
        ...
        "httpclient-4.1.1.jar", "httpcore-4.1.jar", "httpmime-4.1.1.jar", "groovy-2.3.7.jar"};
